# 🚀 Supra WhatsApp API - By NyxObscura

![GitHub stars](https://img.shields.io/github/stars/NyxObscura/Supra?style=social)
![GitHub license](https://img.shields.io/github/license/NyxObscura/Supra)
![Node.js](https://img.shields.io/badge/node-%3E%3D14.0-green)
![Contributors](https://img.shields.io/github/contributors/NyxObscura/Supra)

Supra WhatsApp API adalah library berbasis Node.js untuk berkomunikasi dengan WhatsApp Web tanpa perlu WebSocket tambahan. Ini adalah hasil modifikasi dari Whiskey Supra agar lebih stabil dan mendukung lebih banyak tipe pesan.
...
```sh
npm install @NyxObscura/Supra
```

Atau dengan **Yarn**:

```sh
yarn add @NyxObscura/Supra
```
...
```javascript
import makeWASocket, { DisconnectReason } from '@NyxObscura/Supra'
...
📖 **Dokumentasi lengkap:** [Supra API Docs](https://github.com/adiwajshing/Supra/wiki)
...
```ts
const { generateWAMessageFromContent, proto } = require("@NyxObscura/Supra")
...
💡 Punya ide keren? Silakan buat **Issue** di [repository ini](https://github.com/NyxObscura/Supra/issues).  
...
🌍 **Website**: [Supra API](https://github.com/NyxObscura/Supra)  
